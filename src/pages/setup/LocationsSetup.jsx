...
export default function LocationsSetup() {
  ...
  return (
    <>
      ...
      <ConfirmDialog isOpen={!!deleteTarget} title="Delete Location" description={deleteTarget ? `Are you sure you want to delete ${deleteTarget.name || 'location'}?` : ''} confirmLabel="Delete" onCancel={() => setDeleteTarget(null)} onConfirm={handleDelete} isLoading={isSaving} />
