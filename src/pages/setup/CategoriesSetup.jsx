...
const STORAGE_KEY = 'cms_setup_categories';
...
export default function CategoriesSetup() {
  ...
  const handleSave = () => {
    ...
    try {
      ...
      setItems(nextItems);
      saveItems(nextItems);
      toast.success(editingItem ? 'Category updated' : 'Category created', editingItem ? 'Category updated successfully.' : 'Category created successfully.');
      closeModal();
    } catch (errorMessage) {
  ...
  return (
    <>
                  ...
                  {isLoading ? (
                    <tr>
                      <td colSpan={3} className="px-8 py-6 text-center">
                        <TableLoader label="Loading category records..." />
                      </td>
                    </tr>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className={`w-full rounded-xl border bg-white px-4 py-2.5 text-sm text-gray-900 transition-all focus:border-brand focus:outline-none focus:ring-4 focus:ring-brand/10 ${validationError ? 'border-rose-400' : 'border-gray-200'}`}
                      />
      ...
      <ConfirmDialog
        ...
        description={deleteTarget ? `Are you sure you want to delete ${deleteTarget.name || 'category'}?` : ''}
        confirmLabel="Delete"
